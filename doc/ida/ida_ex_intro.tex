...
and \id{SUNDIALS\_DOUBLE\_PRECISION} to test if the solver libraries were built
in float128, extended or double precision,and use the appropriate conversion
